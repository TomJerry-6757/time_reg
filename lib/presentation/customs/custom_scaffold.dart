...
class CustomScaffold extends StatefulWidget {
  ...
  const CustomScaffold({super.key, required this.title, required this.body, this.hideAppBar = false, this.isHomeScreen = false, this.backgroundColor = Colors.white, this.homeAppbar = false, this.floatingActionButton});
...
class _CustomScaffoldState extends State<CustomScaffold> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(padding: const EdgeInsets.symmetric(horizontal: 30.0), child: widget.body),
